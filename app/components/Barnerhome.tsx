                  ...
                  <div className="relative top-0 flex flex-col justify-end py-10 px-3 h-full text-white">
                    ...
                    <span className="flex gap-5">
                      <div className="flex gap-4 pt-4">
                        <Link
                          href={`/Movie/${data?.id}`}
                          className="bg-[#ffffff2a] py-2 px-10 hover:bg-primary transition-all rounded backdrop-blur-md"
                        >
                          View
                        </Link>
                        <button className="bg-[#ffffff2a] py-2 px-8 rounded backdrop-blur-md">
                          Wishlist
                        </button>
                      </div>
                    </span>
